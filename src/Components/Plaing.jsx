...
const Plaing = () => {
  const planingdata = [
    { name1: "Basic transitions", playn: "BASIC PLAN" ,name2: "Basic cut and trim editing", name3: "Sync audio and video", price: "500", img: "./img/heartHealth.svg" },
    { name1: "Advanced editing (cut, transitions, audio sync)", playn: "PREMIUM PLAN", name2: "Color grading and visual enhancements", name3: "Up to 2 rounds of revisions", price: "800", img: "./img/plan1.png" },
    { name1: "Full professional video editing (includes motion graphics, transitions, and effects)", playn: "PRO PLAN" ,name2: "professional thumbnail design", name3: "Unlimited revisions and priority delivery", price: "1200", img: "./img/money1.png" },
  ];
